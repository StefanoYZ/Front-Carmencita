  ...
  return (
    <form className="space-y-6" onSubmit={onSubmit}>
      ...
      <section>
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          <Input label="Origen" name="origen" value={form.origen} onChange={onChange} error={errors.origen} required />
          <Input label="Destino" name="destino" value={form.destino} onChange={onChange} error={errors.destino} required />
          <Input label="Descripcion" name="descripcion" value={form.descripcion} onChange={onChange} error={errors.descripcion} required />
          <label className="block">
            <span className="mb-1.5 block text-sm font-medium text-gray-700">Tipo de contenido</span>
            <select
              name="tipo_contenido"
            ...
            {errors.tipo_contenido && <span className="mt-1 block text-xs font-semibold text-red-600">{errors.tipo_contenido}</span>}
          </label>
          ...
          <label className="block">
            ...
            {errors.fragilidad && <span className="mt-1 block text-xs font-semibold text-red-600">{errors.fragilidad}</span>}
          </label>
          {mode === 'edit' && (
            <label className="block">
              ...
              {errors.estado && <span className="mt-1 block text-xs font-semibold text-red-600">{errors.estado}</span>}
            </label>
          )}
        </div>
      </section>
